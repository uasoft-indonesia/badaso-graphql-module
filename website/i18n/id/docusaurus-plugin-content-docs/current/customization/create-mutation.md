...
1. Buat file kelas baru di `app\CustomizeBadasoGraphQL\ExampleMutationField::class`
```
<?php
...
```
3. Daftarkan nama kelas di config `badaso-graphql-customize.php` on the `type` 
```
...
'mutation' => [
    ...
